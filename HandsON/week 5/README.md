...
This folder contains the Angular training exercises completed in Week 5.
...
These hands-on exercises cover the core Angular concepts introduced during Week 5, including:

- Environment setup and first component creation
